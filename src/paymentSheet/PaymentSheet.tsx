...
const styles = StyleSheet.create({
  ...
  row: { minHeight: 64, borderWidth: StyleSheet.hairlineWidth, paddingHorizontal: 14, paddingVertical: 11, marginVertical: 4, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  methodInfo: { flex: 1, flexDirection: "row", alignItems: "center", gap: 12 },
  methodText: { flex: 1 },
  ...
  logoTile: { width: 40, height: 40, borderRadius: 10, padding: 5, backgroundColor: "#FFFFFF", borderWidth: StyleSheet.hairlineWidth, justifyContent: "center", alignItems: "center" },
