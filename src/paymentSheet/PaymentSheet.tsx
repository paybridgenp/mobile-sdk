...
const styles = StyleSheet.create({
  ...
  row: { minHeight: Platform.OS === "android" ? 60 : 64, borderWidth: StyleSheet.hairlineWidth, paddingHorizontal: 14, paddingVertical: Platform.OS === "android" ? 8 : 11, marginVertical: Platform.OS === "android" ? 3 : 4, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  methodInfo: { flex: 1, flexDirection: "row", alignItems: "center", gap: Platform.OS === "android" ? 10 : 12 },
  methodText: { flex: 1 },
  rowLabel: { fontSize: Platform.OS === "android" ? 15 : 16, fontWeight: "700" },
  rowSub: { marginTop: 2, fontSize: Platform.OS === "android" ? 13 : undefined, lineHeight: Platform.OS === "android" ? 18 : undefined },
  ...
  logoTile: { width: Platform.OS === "android" ? 36 : 40, height: Platform.OS === "android" ? 36 : 40, borderRadius: Platform.OS === "android" ? 9 : 10, padding: 5, backgroundColor: "#FFFFFF", borderWidth: StyleSheet.hairlineWidth, justifyContent: "center", alignItems: "center" },
